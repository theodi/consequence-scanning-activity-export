require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/SCORM_API_wrapper', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/react-beautiful-dnd.min.js'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, pipwerks, lzmaMin, lzma_workerMin_js, reactBeautifulDnd_min_js) {
  ...
  class DndMultipleView$2 extends QuestionView$1 {
    preinitialize() {
      var _this = this;
  ...
  DndMultipleView$2.template = 'dndMultiple.jsx';
  var DndMultipleView$3 = __AMD("components/adapt-dnd-multiple 2/js/DndMultipleView", DndMultipleView$2);

  var DndMultipleModel$1 = __AMD("components/adapt-dnd-multiple 2/js/DndMultipleModel", class DnDMultipleModel extends QuestionModel$1 {
    init() {
      super.init();
      this.checkCanSubmit();
      console.log(this.get('_items'));
      const openTextComponent = Adapt$1.findById(this.get('textId')[this.get('textId').length - 1]);
    ...
    updateItems() {
      const updatedValues = this.get('textId').map(a => Adapt$1.findById(a).get('_items').map(item => item.userAnswer)).flat();
  ...
  __AMD("components/adapt-dnd-multiple 2/js/adapt-dnd-multiple", components$1.register('dnd-multiple', {
    model: DndMultipleModel$1,
    view: DndMultipleView$3
  }));
  ...
  var DndMultipleModel = __AMD("components/adapt-dnd-multiple/js/DndMultipleModel", class DnDMultipleModel extends QuestionModel$1 {
    init() {
      ...
      if (!textId.length) {
        ...
        const userInput = Adapt$1.findById(textId[textId.length - 1]);
  ...
  register("textinput", function TextInput(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        ...
        className: "icon",
        "aria-hidden": "true"
      })))), index === props._items.length - 1 && React__default["default"].createElement("div", {
        className: "textinput-item__add-container"
      }, React__default["default"].createElement("button", {
        className: "textinput-item__add js-textinput-add",
        type: "button",
        "aria-label": _globals._accessibility._ariaLabels.add
      }, React__default["default"].createElement("div", {
        className: "icon",
        "aria-hidden": "true"
